const CACHE_VERSION = 'italpont-v6.0.5-shell-3';
const SHELL = [
  './','./index.html','./platform.js','./native.js','./pwa.js','./theme-v580.css','./theme-v590.css','./theme-v600.css?v=6.0.5','./manifest.webmanifest',
